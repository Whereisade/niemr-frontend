    ...
    <div className="min-h-[calc(100dvh-68px)] bg-gradient-to-b from-blue-50 to-white">
      <div className="mx-auto max-w-5xl px-4 py-16 grid md:grid-cols-2 items-center gap-10">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-extrabold text-slate-900">Patient Sign In</h2>
          <p className="mt-2 text-slate-700">Access results, medications and manage dependents.</p>
          <ul className="mt-4 space-y-2 text-sm text-slate-700">
            <li>• Dependents management</li><li>• Labs & imaging results</li><li>• Appointments & reminders</li>
          </ul>
        </div>
